...
//
//   可以将app/assets/javascripts, lib/assets/javascripts, vendor/assets/javascripts想象成一个逻辑目录，然后rails 的 pipeline
// 引擎会到逻辑目录里去找这个文件中提到的 js 文件，然后编译到application.js里面去。 但是需要注意的是，require_tree不会到逻辑目录里去找，
// 而是只到'app/assets/javascripts'里去找。所以即使你用了requre_tree . , 你还是需要手动将 lib 和 vendor 里需要的 js 文件包含进来。
